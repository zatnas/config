...
nnoremap ò :s/
nnoremap Ò :%s/
nnoremap <silent> Ý :bn
nnoremap <silent> Û :bp
nnoremap <silent> â :ls
nnoremap Ì 5zl
nnoremap ì zl
nnoremap È 5zh
nnoremap è zh
cabbr wq w | confirm quit
cabbr q confirm quit
let &cpo=s:cpo_save
unlet s:cpo_save
set autoread
set background=dark
...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/emmet-vim/,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after
set scrolloff=5
set shiftwidth=2
set showbreak=>\ 
set showcmd
...
set shortmess=aoO
badd +1 main.c
badd +0 ~/git/kmousetool/kmousetool/kmousetool.cpp
badd +1 Makefile
argglobal
silent! argdel *
argadd main.c
...
silent! normal! zE
let s:l = 25 - ((11 * winheight(0) + 10) / 21)
...
wincmd w
argglobal
edit ~/git/kmousetool/kmousetool/kmousetool.cpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 436 - ((20 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
436
normal! 015|
lcd ~/git/kmousetool/kmousetool
wincmd w
exe '1resize ' . ((&lines * 21 + 23) / 46)
exe 'vert 1resize ' . ((&columns * 84 + 85) / 170)
exe '2resize ' . ((&lines * 22 + 23) / 46)
